<template>
	<div class="carouselbar">
		<div class="container">
			<div class="carousel">
				<img class="item" v-for="(item, i) in itemList" :src="require('../assets/'+item.picUrl)" :title="item.title"  v-show="i==currentItem">
				<!-- 轮播广告内容2： 上/下一张轮播控制器 -->
				<div class="control_left" @click="prev()">
					<van-icon name="arrow-left" size=50 />
				</div>
				<div class="control_right" @click="next()">
